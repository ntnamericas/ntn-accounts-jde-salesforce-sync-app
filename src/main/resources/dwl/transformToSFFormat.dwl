...
payload map (record) -> {
 ...
 "RecordTypeId": record.RecordType default "",
 "Address_Type__c": record.Address_Type__c default "",
 ...
 //"Effective_Date__c": if (record.Effective_Date__c == 0) "" else record.Effective_Date__c as DateTime {format: "yyyy-MM-dd'T'HH:mm:ss.SSSZ"} ,
